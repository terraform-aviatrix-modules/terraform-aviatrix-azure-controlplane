...
locals {
  controller_urn = format("%s:%s:%s:%s",
    jsondecode(data.http.controller_image_info.response_body)["g3"]["amd64"]["Azure ARM"]["publisher"],
    jsondecode(data.http.controller_image_info.response_body)["g3"]["amd64"]["Azure ARM"]["offer"],
    jsondecode(data.http.controller_image_info.response_body)["g3"]["amd64"]["Azure ARM"]["sku"],
    jsondecode(data.http.controller_image_info.response_body)["g3"]["amd64"]["Azure ARM"]["version"]
  )
