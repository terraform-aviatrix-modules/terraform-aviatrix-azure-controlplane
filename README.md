...
| <a name="input_incoming_service_tags"></a> [incoming\_service\_tags](#input\_incoming\_service\_tags) | Incoming service tags for security group used by controller and copilot| `list(string)` | `[]` | no |
